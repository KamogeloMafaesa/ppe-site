...
function Home(){
    ...
    <div >
        ...
        <div className="relative w-full">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white">Welcome to Mafaesa Trading Enterprise </h1>
            <p className="mt-4 text-white/90">Your trusted partner for your safety gear and protective equipment.</p>
