...
const count = items.reduce((sum, i) => sum + i.quantity, 0)
 ...
 const navLinkStyles = ({ isActive }) =>
    ...
    return(
        <main>
        <header className="w-full bg-white shadow-sm bg-red-600">
            <div className="container max-w-7xl mx-auto flex justify-between items-center p-4 navbar">
                <Link to="/" className="logo text-2xl font-bold text-blue-600"><img src={Logo} alt="Mafaesa Trading Enterprise Logo." className="w-100 h-25" /></Link>
